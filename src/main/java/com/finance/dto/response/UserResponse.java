...
/**
 * User Response DTO - User data for API responses
 * 
 * Notice: Password is NOT included for security reasons
 * 
 * Includes a static factory method to convert from Entity
 */
